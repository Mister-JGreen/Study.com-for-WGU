...
/* Switch to public_library Database */
USE public_library;
...
CREATE TABLE tblAuthor (
    ...
    AuthorNationality VARCHAR(25) NOT NULL,
...
CREATE TABLE tblBook (
    ...
    PRIMARY KEY (BookID),
    FOREIGN KEY (BookAuthor) REFERENCES tblAuthor (AuthorID)
);
...
/* Inserting Data from Excel Sheets 
After formatting cells in Excel to include single quotes around strings and saving as a CSV file;
data was then copy and pasted into workbench; parentheses and commas were added; 
data was formatted to a sinlge line on mySQL workbench */
INSERT INTO tblAuthor(AuthorID, AuthorFirstName, AuthorLastName, AuthorNationality) VALUES
(1,'Sofia','Smith','Canada'),(2,'Maria','Brown','Brazil'),(3,'Elena','Martin','Mexico'),(4,'Zoe','Roy','France'),(5,'Sebastian','Lavoie','Canada'),(6,'Dylan','Garcia','Spain'),(7,'Ian','Cruz','Mexico'),(8,'Lucas','Smith','USA'),(9,'Fabian','Wilson','USA'),(10,'Liam','Taylor','Canada'),(11,'William','Thomas','Great Britain'),(12,'Logan','Moore','Canada'),(13,'Oliver','Martin','France'),(14,'Alysha','Thompson','Canada'),(15,'Isabelle','Lee','Canada'),(16,'Emily','Clark','USA'),(17,'John','Young','China'),(18,'David','Wright','Canada'),(19,'Thomas','Scott','Canada'),(20,'Helena','Adams','Canada'),(21,'Sofia','Carter','USA'),(22,'Liam','Parker','Canada'),(23,'Emily','Murphy','USA');

# A single line for all values seems counterintuitive; much easier to format and catch errors when left on seperate lines 
INSERT INTO tblBook(BookID, BookTitle, BookAuthor, Genre) VALUES
...
# Created a macro in Microsoft Word to help automate the parentheses and commas required to seperate each value in the table
# Name O'Quinn had to be edited to use " ", rather than single quotes
INSERT INTO tblClient(ClientID, ClientFirstName, ClientLastName, ClientDoB, Occupation) VALUES
...
# BorrowDate column edited to fit DATE format
INSERT INTO tblBorrower(BorrowID, ClientID, BookID, BorrowDate) VALUES
(1,35,17,'2016-07-20'),
(2,1,3,'2017-04-19'),
(3,42,8,'2016-10-03'),
(4,62,16,'2016-04-05'),
